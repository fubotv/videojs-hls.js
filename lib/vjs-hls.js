// Copyright 2016 Streamroot, Corp.
// with changes by Roman Kurbatov, Vakoms
...
(function (window, videojs, Hls) {
    ...
    function StreamrootProviderHLS(source, tech) {
        ...
        function initialize() {
            ...
            // Set custome error handler form hls.js config passed to video.js or use default
            _hls.on(Hls.Events.ERROR, (typeof hlsjsConfig.onerror === 'function') ? hlsjsConfig.onerror : _onError);
